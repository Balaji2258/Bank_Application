...
<body>
	...
	try {
		...
		if(session.getAttribute("adminId") != null) {
			...
			String sql = "select * from transactions where acc_no = " + userAccNo + ";";
	...
	<div class="content">
		<div class="container">
				<table id="transaction_table" class = "tab">
					<tr>
						<th colspan=5 align="center" class="tabhead">TRANSACTIONS : <%= userAccNo %></th>
					</tr>
					<tr>
						<td colspan="5"></td>
					</tr>
	...
	%>
					<tr>
						<td colspan=5 align="center">User has no transactions yet!</td>
					</tr>
	<%
			}
			else {
